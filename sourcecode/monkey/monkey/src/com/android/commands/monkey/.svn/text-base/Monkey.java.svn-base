...
public class Monkey {
    ...
    private int run(String[] args) {
        ...
        if (mScriptFileName != null) {
            ...
            mEventSource = new MonkeySourceRandom(mSeed, mMainApps, mThrottle, mThrottleTouch, mThrottleKey);
            mEventSource.setVerbose(mVerbose);
    ...
    private boolean processOptions() {
        ...
        try {
            ...
            while ((opt = nextOption()) != null) {
                ...
                } else if (opt.equals("--throttle-touch")) {
                	mThrottleTouch = nextOptionLong("delay (in milliseconds) to wait before Motion events");
                } else if (opt.equals("--throttle-key")) {
                	mThrottleKey = nextOptionLong("delay (in milliseconds) to wait before Key events");
    ...
    private void showUsage() {
      ...
      System.err.println("              [--throttle-touch MILLISEC] [--throttle-key MILLISEC]");
